...
namespace CoreGram.Repositories
{
    public class PostRepository
    {
        ...
        public IEnumerable<PostInfoDto> GetAll()
        {
        ...
        public IEnumerable<PostInfoDto> GetByUser(int userId)
        {
        ...
        public IEnumerable<PostInfoDto> GetByFollowings(int userId)
        {
            ...
            var model = _context.Posts.Where(x => followersIds.Contains(x.UserId))
                                    .Include(x => x.User)
                                    .Include(x => x.Likes)
                                    .Include(x => x.PostsComments)
                                        .ThenInclude(x => x.Comment)
        ...
        public PostDto Delete(int postId)
        {
            ...
            var model = _context.Posts.Find(postId);
            if (model != null)
            {
