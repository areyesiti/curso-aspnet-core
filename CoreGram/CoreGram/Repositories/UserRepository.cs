...
namespace CoreGram.Repositories
{
    public class UserRepository
    {
        ...
        public AuthDto Authenticate(LoginDto auth)
        {            
            ...
            var user = _context.Users.Include(x => x.Profile).SingleOrDefault((x => x.Login == auth.Login));
        ...
        public UserInfoDto Create(UserDto dto)
        {
        ...
        public UserInfoDto Update(int userId, UserDto dto)
        {
        ...
        public UserInfoDto Delete(int userId)
        {
            // Obtenemos y comprobamos que existe el usuario
            var model = _context.Users.Find(userId);
            if (model != null)
            {
